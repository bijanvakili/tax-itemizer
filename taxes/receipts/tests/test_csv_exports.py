...
def test_dump_forex_rates(t_file):
    models.ForexRate.objects.bulk_create([
        models.ForexRate(effective_at=isodstr('2017-11-01'), pair='CAD/USD',
                         rate=Decimal('1.2345')),
        models.ForexRate(effective_at=isodstr('2017-11-02'), pair='CAD/USD',
                         rate=Decimal('1.4343')),
        models.ForexRate(effective_at=isodstr('2017-11-03'), pair='CAD/USD',
                         rate=Decimal('1.5555')),
    ])
