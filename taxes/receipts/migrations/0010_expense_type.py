...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='receipt',
            name='expense_type',
            field=enumfields.fields.EnumField(default='ignore', enum=taxes.receipts.types.ExpenseTypeEnum, max_length=14),
        ...
        migrations.AddField(
            ...
            field=enumfields.fields.EnumField(blank=True, db_index=True, enum=taxes.receipts.types.ExpenseTypeEnum, max_length=14, null=True),
        ),
        ...
        migrations.AlterField(
            model_name='receipt',
            name='expense_type',
            field=enumfields.fields.EnumField(enum=taxes.receipts.types.ExpenseTypeEnum, max_length=14),
            preserve_default=False,
        ),
